...
// important constants for this clas
const int DEFAULT_MAX_ITEMS = 200;

// data type of objects in sequence 
...
public:
	...
	Sequence(const int numMaxItems);    // Create an empty sequence (i.e., one whose size() is 0).
...
private:
	...
	ItemType* m_seqArray; // pointer to array holding the objects in the sequence
